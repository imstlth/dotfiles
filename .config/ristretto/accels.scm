...
; (gtk_accel_path "<Actions>/RsttoWindow/default-zoom-menu" "")
...
; (gtk_accel_path "<Actions>/RsttoWindow/show-containing-folder" "")
...
; (gtk_accel_path "<Actions>/RsttoWindow/copy-image" "<Primary>c")
...
; (gtk_accel_path "<Actions>/RsttoWindow/default-zoom-100" "<Alt>0")
...
; (gtk_accel_path "<Actions>/RsttoWindow/default-zoom-fit" "<Alt>equal")
; (gtk_accel_path "<Actions>/RsttoWindow/default-zoom-smart" "<Alt>asterisk")
...
; (gtk_accel_path "<Actions>/RsttoWindow/print" "<Primary>p")
